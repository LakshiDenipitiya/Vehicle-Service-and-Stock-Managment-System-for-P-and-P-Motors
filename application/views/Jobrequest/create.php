...
.required:after {
 ...
 .content{
    background-image: url("<?php echo base_url('assertsN/images/img21.jpg');?>");
     /* Full height */
    height: 25%; 
...
<div class="container">
    <div class="box box-default col-md-8 col-md-offset-2" style="background-color:#faffc5;">
        ...
        <div class=" col-md-12 ">
 <?php if($this->session->flashdata("messagejbreq")):?>
   <p class="alert alert-success alert-dismissible">
     <button class="close" aria-hidden="true" type="button" data-dismiss="alert">×</button>
     <?php echo $this->session->flashdata("messagejbreq");?>
   </p>
 <?php endif; ?>
</div>
