...
<section class="content">
    ...
    <div class="box box-default">
        ...
        <div class="box-header with-border"><h3 align="center" class="box-title">Edit Module </h3>
        ...
        <div class="box-body">
           ...
           <?php echo form_open('Module/update/'.$selectedUser->id) ?>
    ...
    <div class = "row">
        ...
        <div class= "col-md-4 col-md-offset-0">
            <?php echo form_input(array('id' => 'name', 'name' => 'name', 'class' => 'form-control','value' => $selectedUser->name)); ?>
