...
<section class="content">
  <div class="box box-default">
    ...
    <div class="box-body">
      ...
      <?php echo form_open('Jobrequest/view/'.$selectedUser->id) ?>
    ...
    <div class="page-header">
      ...
      <fieldset class = "col-md-12">
        <div class="row">
            <div class="col-md-2">
              <?php echo form_label("Next Service :")?>
            </div>
            <div class="col-md-2">
                  <?php echo $invoice->nextservicedate; ?> 
            </div>
            ...
            <div class="col-md-2">
                <?php echo $invoiceno->meterreading; ?>  
            </div>

            <div class="col-md-2">
              <?php echo form_label("Job Done by :")?>
            </div>
            <div class="col-md-2">
               <?php echo $emoplyee->firstname; ?>  
            </div>
        </div>
      </fieldset>
<hr></hr>
