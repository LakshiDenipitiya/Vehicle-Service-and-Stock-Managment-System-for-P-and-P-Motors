        ...
        <table style="border: 1px solid black;width: 80%;" id="detail">
            ...
            <tr>
                <td style="padding-left: 10px;padding-right: 10px;padding-top:5px;
                    ...
                    text-align: left;
                    background-color: #7b7b7b;
                    color: white;" width="50%">Good Received Date</td>
                <td style="padding-left: 10px;padding-right: 10px;padding-top:5px;                    padding-bottom: 5px;                    text-align: left;                    background-color: #cacaca;                    color: black;"><?php echo $detail_list[0]->goodsreceivenoticedate; ?></td> 
            </tr>
            <tr>
                <td style="padding-left: 10px;padding-right: 10px;padding-top:5px;
                    padding-bottom: 5px;
                    text-align: left;
                    background-color: #7b7b7b;
                    color: white;" width="50%">Supplier Invoice No</td>
                <td style="padding-left: 10px;padding-right: 10px;padding-top:5px;                    padding-bottom: 5px;                    text-align: left;                    background-color: #cacaca;                    color: black;"><?php echo $detail_list[0]->invoiceno; ?></td> 
            </tr>
            <tr>
                <td style="padding-left: 10px;padding-right: 10px;padding-top:5px;
                    padding-bottom: 5px;
