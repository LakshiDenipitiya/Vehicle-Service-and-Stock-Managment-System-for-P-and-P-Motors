    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-forward"></i> P and P Motors
            <small class="pull-right">Date: Generated Date()</small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
            Thank You for Coming. We are always here for make your vehicle healthy and fitness. 
          </p>
        </div>
        <!-- /.col -->
        <div class="col-xs-6">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="<?php echo base_url('reports/exports/example'); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
